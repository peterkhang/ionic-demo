(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
    ...
    /***/
    function HJ8D(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function VDsy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_login_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./login.html */
      "ZMpf");
      /* harmony import */


      var _login_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./login.scss */
      "HJ8D");
      /* harmony import */
      ...
      var _providers_common_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
        ...
        _createClass(LoginPage, [{
          ...
          value: function login() {
            if (!this.loginForm.valid) {
              for (var key in this.loginForm.controls) {
                if (!this.loginForm.controls[key].valid) {
                  this.auth.showError(key + ' : ' + this.auth.message.get('form.field.invalid')); //this.loginForm.get(key).focus() ;
            ...
            */
            ...
            this.auth.navigateRoot('/MainPage'); // ToDo : This is real login code
    ...
    /***/
    function ZMpf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
